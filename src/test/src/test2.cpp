...
int main( int argc, char** argv ){
	...
	Mat test_image = imread("/media/prakhar/Linux FIles/Flam Apps/Testing and experiment/DataSets/Colorful Patterns/Image.orig33.jpg");
	...
	for (int Class=0; Class<=9; Class++){
		for (int img=1; img<=79; img++){
			int image_number = img + Class*100;
			String number;
			ostringstream conv_n;
			conv_n << image_number;
			number = conv_n.str();
			Mat src_color = imread("/media/prakhar/Linux FIles/Flam Apps/Testing and experiment/DataSets/Colorful Patterns/"+number+".jpg");
