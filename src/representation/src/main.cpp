...
int main()
{
    ...
    vision::Mat test_images =  vision::imread("/media/prakhar/Linux FIles/Flam Apps/Testing and experiment/DataSets/school_bag/Image_49 Bag.jpg",vision::IMREAD_GRAYSCALE);
    float average = _image_contours_average(test_images);
    dbg_d(average);
    return 0;
}
